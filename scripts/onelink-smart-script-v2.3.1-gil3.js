/**
 * AF Smart Script (Build 2.3.1-gil3)
 */
...
var validateReferrer = function validateReferrer(_ref2) {
  var _mediaSource$keys;

  var mediaSource = _ref2.mediaSource,
...
var extractCustomParams = function extractCustomParams() {
  var afCustom = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var currentURLParams = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var googleClickIdKey = arguments.length > 2 ? arguments[2] : undefined;
  var afParams = {};
...
var validateParams = function validateParams() {
  ...
  var mediaSource = params.mediaSource,
      ...
      af_media_source = params.af_media_source,
      af_campaign_id = params.af_campaign_id,
      afCustom = params.afCustom,
      googleClickIdKey = params.googleClickIdKey; // af_js_web=true and af_ss_ver=[version] will be added to every URL that was generated through this script
  ...
  if (af_campaign_id) {
    afParams['af_campaign_id'] = getParameterValue(currentURLParams, af_campaign_id);
  }
  
  if (af_media_source) {
    afParams['af_media_source'] = getParameterValue(currentURLParams, af_media_source);
  }
  ...
  var customParams = extractCustomParams(afCustom, currentURLParams, googleClickIdKey);
...
(function () {
  var generateOneLinkURL = function generateOneLinkURL() {
    ...
    var afParams = validateParams(parameters.afParameters, currentURLParams);
  ...
  var generateDirectClickURL = function generateDirectClickURL(_ref3) {
    var _ref3$afParameters = _ref3.afParameters,
        afParameters = _ref3$afParameters === void 0 ? {} : _ref3$afParameters,
        _ref3$referrerSkipLis = _ref3.referrerSkipList,
    ...
    var currentURLParams = getURLParametersKV(window.location.search);
    var afParams = validateParams(afParameters, currentURLParams);
    if (!afParams) return null;
    var finalParams = stringifyParameters(afParams);
    var finalURL = "https://engagements.appsflyer.com/v1.0/c2s/click/app/".concat(platform, "/").concat(app_id).concat(finalParams.replace('&', '?'), "&af_r=").concat(redirectURL);

...
var removeExpiredLocalStorageItems = function removeExpiredLocalStorageItems() {
  ...
  localStorage.setItem(
    "ss_incoming_params",
    JSON.stringify(
      incomingParams.filter(function (_ref3) {
...
var isOneLinkURLValid = function isOneLinkURLValid(oneLinkURL) {
  ...
  var oneLinkURLParts =
    (_ref4 = oneLinkURL || "") === null || _ref4 === void 0
      ? void 0
      : _ref4.toString().match(AF_URL_SCHEME);
...
var isSkipListsValid = function isSkipListsValid(_ref5) {
  var _ref5$referrerSkipLis = _ref5.referrerSkipList,
    referrerSkipList =
      _ref5$referrerSkipLis === void 0 ? [] : _ref5$referrerSkipLis,
...
var extractCustomParams = function extractCustomParams(_ref6) {
  var _ref6$afCustom = _ref6.afCustom,
    ...
    currentURLParams =
      _ref6$currentURLParam === void 0 ? {} : _ref6$currentURLParam,
...
(function () {
  ...
  var generateDirectClickURL = function generateDirectClickURL() {
    ...
    var _parameters$afParamet2 = parameters.afParameters,
      afParameters =
        _parameters$afParamet2 === void 0 ? {} : _parameters$afParamet2,
